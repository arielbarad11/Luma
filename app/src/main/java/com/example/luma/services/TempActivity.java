...
import com.example.luma.databinding.ActivityTempBinding;
...
public class TempActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarTemp.toolbar);
        binding.appBarTemp.fab.setOnClickListener(new View.OnClickListener() {
            @Override
